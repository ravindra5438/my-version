...
import {createStory, getStoryCategories, uploadStoryImage, getDataById} from "../utilities/ApiCalls";
...
export default function StoryCreate(props) {
    ...
    function submitStory(e) {
        ...
        createStory(storyForm).then(response => {
                                ...
                                <div className="row mt-30 form_title">
                                    ...
                                    <div className="col-lg-12 col-sm-6 col-md-6 col-12">
                                        <div className="heading_title">
                                            <h1>Enter story title *</h1>
                                            <span>(It should be max 50 words.)</span>
                                        </div>
                                        <div className="form-group">
                                            <input type="text" className="form-control" placeholder="Story name"
                                    ...
                                    <div className="col-lg-12 col-sm-6 col-md-6 col-12">
                                        ...
                                        <div className="form-group">
                                            <input type="text" className="form-control" placeholder="duration of story"
